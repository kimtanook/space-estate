...
function PhysicsScene() {
  ...
  useEffect(() => {
    ...
    const cubeBody = new CANNON.Body({mass: 1}); // mass : 질량
    ...
    const sphereBody = new CANNON.Body({mass: 1}); // mass : 질량
    ...
    const icosahedronBody = new CANNON.Body({mass: 1}); // mass : 질량
    ...
    const torusKnotBody = new CANNON.Body({mass: 1}); // mass : 질량
